...
public class Cores {
		...
		//Para resetar as cores do texto
		public static final String TEXT_RESET = "\u001B[0m";

		//Cores para texto basica
		...
		// Efeito de brilho ou cor mais clara
		...
		// Efeito de brilho ou cor mais clara, com negrito
		...
		// Cores mais claras para fundo de tela
